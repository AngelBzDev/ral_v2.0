   ...
   <div class="h-full my-auto bg-white md:grid md:grid-cols-2 rounded-2xl px-7 md:p-0">
      <div class="flex flex-col content-center h-full text-center" >
         <!-- <nav class="container flex items-center content-around w-full px-0 py-2 md:px-2">
            <img src="img/logo.png" alt="Logo RAL" class="flex-grow-0 w-10">
            <p class="flex-1 text-3xl font-bold text-center">RAL</p>
            <a href="#" class="block w-20 p-2 text-center text-white bg-blue-900 rounded">Registro</a>
         </nav> -->
         <div class="mt-10 mb:mt-10 arriba">
            <img src="img/logo.png" alt="Logo RAL" class="w-16 mx-auto mb-10">
            <h1 class="text-4xl font-bold md:text-5xl">Bienvenido a RAL</h1>
            <p class="mb-7">Registro de aulas y laboratorios</p>
         </div>
         <!-- <div class="flex items-center p-2 mx-auto border rounded shadow w-96">
            <img src="img/logo-google.png" alt="Logo de google" class="flex-grow-0 w-6">
         ...
         <form action="./views/home.html" class="w-full mx-auto mt-6 text-left md:w-7/12 entrar" id="form-login">
            <div id="iniciar-sesion">
               <div class="flex flex-col mb-5">
                  ...
                  <input type="email" name="correo" id="correo" placeholder="Ingrese su correo electronico" class="p-2 border border-transparent border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent">
               </div>
               <div class="flex flex-col mb-1">
                  <label for="pass" class="font-medium">Contraseña</label>
                  <input type="password" name="pass" id="pass" placeholder="Ingrese su contraseña" class="p-2 border border-transparent border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" title="La contraseña debe tener entre 8 y 16 caracteres, al menos un dígito, al menos una minúscula y al menos una mayúscula. Puede tener otros símbolos." autocomplete="on">
               </div>
               <div class="mb-5">
                  <input type="checkbox" name="mostrar" id="mostrar">
                  <label for="mostrar">Mostrar Contraseña</label>
               </div>
               <input type="submit" class="w-full p-2.5 font-bold text-white uppercase transition duration-500 ease-in-out transform bg-blue-900 border rounded-lg shadow hover:-translate-y-1 hover:scale-110 mb-5" id="btn-login" value="Iniciar sesión"></input>
         ...
         <form class="hidden w-full mx-auto mt-6 text-left md:w-7/12 entrar" id="form-registro" method="POST">
            <div id="registrarse" class="">
               <div class="block w-full md:grid md:grid-cols-2 md:gap-x-4">
                  <div class="flex flex-col mb-5">
                     <label for="nombre" class="font-medium">Nombre(s)</label>
               ...
               <div class="block w-full md:grid md:grid-cols-2 md:gap-x-4">
                  ...
                  <div class="mb-5">
                     ...
                     <label for="mostrar2">Mostrar Contraseñas</label>
                  </div>
               </div>
               <div class="flex flex-col mb-5">
               ...
               <div class="flex content-between w-full mb-10">
