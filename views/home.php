...
<body class="font-serif bg-gradient-to-r from-blue-900 to-blue-300">
   <div id="banner" class="relative w-full h-auto bg-center bg-cover bg-gradient-to-r from-blue-900 to-blue-300">
      ...
      <div class="container items-center justify-between px-6 py-6 mx-auto md:px-20 md:py-10 md:flex">
         <div class="relative entrar">
            <h3 class="mb-2 text-5xl font-bold text-white md:mb-5 md:text-6xl"> <?php echo $_SESSION['sexo'] === 'f' ? 'Bienvenida Profesora': 'Bienvenido Profesor'; ?></h3>
            <h3 class="mb-8 text-5xl font-bold text-white md:text-6xl"><?php echo $_SESSION['nombres']?></h3>
   ...
   <main class="container p-4 mx-auto md:px-20 md:py-10">
      <div class="p-4 mx-2 rounded-lg shadow-sm bg-gray-50 md:mx-12 md:p-10 arriba" id="eleccion">
         ...
         <div class="grid-cols-2 my-12 md:grid">
            <div class="flex flex-col items-center justify-between mb-6 md:mb-0">
               ...
               <a href="#" class="block w-full transition duration-500 ease-in-out transform bg-no-repeat bg-contain border rounded-lg shadow-xl md:w-3/5 h-52 hover:-translate-y-1 hover:scale-110" style="background-image: url(../img/salon.jpg);">
               </a>
            </div>
            <div class="flex flex-col items-center justify-between">
               <p class="mt-5 mb-2 text-2xl font-medium md:my-8">Laboratorio</p>
               <a href="#" class="block w-full transition duration-500 ease-in-out transform bg-no-repeat bg-contain border rounded-lg shadow-xl md:w-3/5 h-52 hover:-translate-y-1 hover:scale-110" style="background-image: url(../img/laboratorio.jpg);">
               </a>
            </div>
         </div>
      </div>
